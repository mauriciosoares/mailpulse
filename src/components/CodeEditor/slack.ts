      ...
      <tr style="width:100%">
        <td>
          ...
          <table align="center" border="0" cellPadding="0" cellSpacing="0" role="presentation" width="100%">
            <tbody>
              <tr>
                <td><a target="_blank" style="color:#b7b7b7;text-decoration:underline" href="https://slackhq.com" rel="noopener noreferrer">Our blog</a>   |   <a target="_blank" style="color:#b7b7b7;text-decoration:underline" href="https://slack.com/legal" rel="noopener noreferrer">Policies</a>   |   <a target="_blank" style="color:#b7b7b7;text-decoration:underline" href="https://slack.com/help" rel="noopener noreferrer">Help center</a>   |   <a target="_blank" style="color:#b7b7b7;text-decoration:underline" href="https://slack.com/community" rel="noopener noreferrer" data-auth="NotApplicable" data-linkindex="6">Slack Community</a>
...
export const text = `CONFIRM YOUR EMAIL ADDRESS
...
Our blog [https://slackhq.com]   |   Policies
[https://slack.com/legal]   |   Help center [https://slack.com/help]   |   Slack
