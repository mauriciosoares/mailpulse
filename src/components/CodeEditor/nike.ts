        ...
        <td>
                  ...
                  <table width="100%" align="center" role="presentation" cellSpacing="0" cellPadding="0" border="0">
                    <tbody style="width:100%">
                      <tr style="width:100%">
                        ...
                        <td align="right"><a target="_blank" style="color:#000;text-decoration:none;border:1px solid #929292;font-size:16px;padding:10px 0px;width:220px;display:block;text-align:center;font-weight:500">Track Package</a></td>
                      </tr>
                    </tbody>
                  </table>
                </td>
          ...
          <table style="padding-left:40px;padding-right:40px;padding-top:22px;padding-bottom:22px" align="center" border="0" cellPadding="0" cellSpacing="0" role="presentation" width="100%">
            <tbody>
              <tr>
                <td>
                  <p style="font-size:15px;line-height:2;margin:0;font-weight:bold">Shipping to: John</p>
                  <p style="font-size:14px;line-height:2;margin:0;color:#747474;font-weight:500">New York</p>
                </td>
              </tr>
            </tbody>
          </table>
              ...
              <tr>
                <td>
                  <table width="100%" align="center" role="presentation" cellSpacing="0" cellPadding="0" border="0">
                    <tbody style="width:100%">
                      <tr style="width:100%">
                        <td><img alt="Brazil 2022/23 Stadium Away Women&#x27;s Nike Dri-FIT Soccer Jersey" src="https://react-email-demo-ijnnx5hul-resend.vercel.app/static/nike-product.png" width="260px" style="display:block;outline:none;border:none;text-decoration:none;float:left" /></td>
          ...
          <table style="padding-left:40px;padding-right:40px;padding-top:22px;padding-bottom:22px" align="center" border="0" cellPadding="0" cellSpacing="0" role="presentation" width="100%">
            <tbody>
              <tr>
                <td>
                  <table width="100%" style="display:inline-flex;margin-bottom:40px" align="center" role="presentation" cellSpacing="0" cellPadding="0" border="0">
                    <tbody style="width:100%">
                      <tr style="width:100%">
                  ...
                  <table width="100%" align="center" role="presentation" cellSpacing="0" cellPadding="0" border="0">
                    <tbody style="width:100%">
                      <tr style="width:100%">
                        <td align="center"><a target="_blank" style="color:#000;text-decoration:none;border:1px solid #929292;font-size:16px;padding:10px 0px;width:220px;display:block;text-align:center;font-weight:500">Order Status</a></td>
                      </tr>
                    </tbody>
                  </table>
                </td>
              ...
              <tr>
                <td>
                  ...
                  <table width="100%" style="padding:20px 0" align="center" role="presentation" cellSpacing="0" cellPadding="0" border="0">
                    <tbody style="width:100%">
                      <tr style="width:100%">
                        <td align="center" style="vertical-align:top;text-align:left;padding-left:4px;padding-right:2px"><img alt="Brazil 2022/23 Stadium Away Women&#x27;s Nike Dri-FIT Soccer Jersey" src="https://react-email-demo-ijnnx5hul-resend.vercel.app/static/nike-recomendation-1.png" width="100%" style="display:block;outline:none;border:none;text-decoration:none" />
                        ...
                        <td align="center" style="vertical-align:top;text-align:left;padding-left:2px;padding-right:2px"><img alt="Brazil 2022/23 Stadium Away Women&#x27;s Nike Dri-FIT Soccer Jersey" src="https://react-email-demo-ijnnx5hul-resend.vercel.app/static/nike-recomendation-2.png" width="100%" style="display:block;outline:none;border:none;text-decoration:none" />
                        ...
                        <td align="center" style="vertical-align:top;text-align:left;padding-left:2px;padding-right:2px"><img alt="Brazil 2022/23 Stadium Away Women&#x27;s Nike Dri-FIT Soccer Jersey" src="https://react-email-demo-ijnnx5hul-resend.vercel.app/static/nike-recomendation-4.png" width="100%" style="display:block;outline:none;border:none;text-decoration:none" />
                        ...
                        <td align="center" style="vertical-align:top;text-align:left;padding-left:2px;padding-right:4px"><img alt="Brazil 2022/23 Stadium Away Women&#x27;s Nike Dri-FIT Soccer Jersey" src="https://react-email-demo-ijnnx5hul-resend.vercel.app/static/nike-recomendation-4.png" width="100%" style="display:block;outline:none;border:none;text-decoration:none" />
                          <p style="font-size:15px;line-height:1;margin:0;padding-left:10px;padding-right:10px;padding-top:12px;font-weight:500">FFF</p>
          ...
          <hr style="width:100%;border:none;border-top:1px solid #eaeaea;border-color:#E5E5E5;margin:0" />
          <table style="padding-left:20px;padding-right:20px;padding-top:20px;background-color:#F7F7F7" align="center" border="0" cellPadding="0" cellSpacing="0" role="presentation" width="100%">
            <tbody>
              <tr>
                <td>
                  ...
                  <table width="100%" style="padding-top:22px;padding-bottom:22px;padding-left:20px;padding-right:20px" align="center" role="presentation" cellSpacing="0" cellPadding="0" border="0">
                    <tbody style="width:100%">
                      <tr style="width:100%">
                        <td colSpan="1" style="width:33%"><a target="_blank" style="color:#000;text-decoration:none;font-size:13.5px;margin-top:0;font-weight:500" href="/">Shipping Status</a></td>
                        <td colSpan="1" style="width:33%"><a target="_blank" style="color:#000;text-decoration:none;font-size:13.5px;margin-top:0;font-weight:500" href="/">Shipping &amp; Delivery</a></td>
                        <td colSpan="1" style="width:33%"><a target="_blank" style="color:#000;text-decoration:none;font-size:13.5px;margin-top:0;font-weight:500" href="/">Returns &amp; Exchanges</a></td>
                      </tr>
                    </tbody>
                  </table>
                  <table width="100%" style="padding-top:0;padding-bottom:22px;padding-left:20px;padding-right:20px" align="center" role="presentation" cellSpacing="0" cellPadding="0" border="0">
                    <tbody style="width:100%">
                      <tr style="width:100%">
                        <td colSpan="1" style="width:33%"><a target="_blank" style="color:#000;text-decoration:none;font-size:13.5px;margin-top:0;font-weight:500" href="/">How to Return</a></td>
                        <td colSpan="2" style="width:66%"><a target="_blank" style="color:#000;text-decoration:none;font-size:13.5px;margin-top:0;font-weight:500" href="/">Contact Options</a></td>
                      </tr>
                    </tbody>
                  </table>
                  <hr style="width:100%;border:none;border-top:1px solid #eaeaea;border-color:#E5E5E5;margin:0" />
                  <table width="100%" style="padding-left:20px;padding-right:20px;padding-top:32px;padding-bottom:22px" align="center" role="presentation" cellSpacing="0" cellPadding="0" border="0">
                    <tbody style="width:100%">
                      <tr style="width:100%">
                        <td>
                          <table width="100%" align="center" role="presentation" cellSpacing="0" cellPadding="0" border="0">
                            <tbody style="width:100%">
                              <tr style="width:100%">
                                <td style="width:16px"><img src="https://react-email-demo-ijnnx5hul-resend.vercel.app/static/nike-phone.png" width="16px" height="26px" style="display:block;outline:none;border:none;text-decoration:none;padding-right:14px" /></td>
                                <td>
            ...
            <tbody>
              <tr>
                <td>
                  ...
                  <table width="100%" style="width:370px;margin:auto;padding-top:12px" align="center" role="presentation" cellSpacing="0" cellPadding="0" border="0">
                    <tbody style="width:100%">
                      <tr style="width:100%">
                        <td align="center"><a target="_blank" style="color:#000;text-decoration:none;font-weight:500" href="/">Men</a></td>
                        <td align="center"><a target="_blank" style="color:#000;text-decoration:none;font-weight:500" href="/">Women</a></td>
                        <td align="center"><a target="_blank" style="color:#000;text-decoration:none;font-weight:500" href="/">Kids</a></td>
                        <td align="center"><a target="_blank" style="color:#000;text-decoration:none;font-weight:500" href="/">Customize</a></td>
                      </tr>
                    </tbody>
                  </table>
                </td>
...
export const text = `Tracking Number
