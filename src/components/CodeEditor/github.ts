        ...
        <td><img alt="Github" src="/email-brands/github.png" width="32" height="32" style="display:block;outline:none;border:none;text-decoration:none" />
          ...
          <table style="padding:24px;border:solid 1px #dedede;border-radius:5px;text-align:center" align="center" border="0" cellPadding="0" cellSpacing="0" role="presentation" width="100%">
            <tbody>
              <tr>
                <td>
                  <p style="font-size:14px;line-height:24px;margin:0 0 10px 0;text-align:left">Hey <strong>john</strong>!</p>
                  <p style="font-size:14px;line-height:24px;margin:0 0 10px 0;text-align:left">A fine-grained personal access token (<a target="_blank" style="color:#067df7;text-decoration:none">resend</a>) was recently added to your account.</p><a target="_blank" style="font-size:14px;background-color:#28a745;color:#fff;line-height:100%;border-radius:0.5em;padding:0px 0px;text-decoration:none;display:inline-block;max-width:100%"><span><!--[if mso]><i style="letter-spacing: undefinedpx;mso-font-width:-100%;mso-text-raise:0" hidden>&nbsp;</i><![endif]--></span><span style="font-size:14px;background-color:#28a745;color:#fff;line-height:120%;border-radius:0.5em;padding:0.75em 1.5em;max-width:100%;display:inline-block;text-decoration:none;text-transform:none;mso-padding-alt:0px;mso-text-raise:0">View your token</span><span><!--[if mso]><i style="letter-spacing: undefinedpx;mso-font-width:-100%" hidden>&nbsp;</i><![endif]--></span></a>
                </td>
              </tr>
            </tbody>
          </table>
          <p style="font-size:14px;line-height:24px;margin:16px 0;text-align:center"><a target="_blank" style="color:#0366d6;text-decoration:none;font-size:12px">Your security audit log</a> ・ <a target="_blank" style="color:#0366d6;text-decoration:none;font-size:12px">Contact support</a></p>
...
export const text = `@john, a personal access was created on your account.
